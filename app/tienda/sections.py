...
def render_shop_catalog(*, penalties: dict, store_locked: bool, current_user: str, available: int | None) -> None:
    ...
    tab_com, tab_bay, tab_comp, tab_bred = st.tabs(["Comodines", "Bayas", "Competitivo", "Crianza"])
    with tab_com:
    ...
    with tab_comp:
        _render_aisle_header("Categoria", "Competitivo", catalog["competitivos"], discounts)
