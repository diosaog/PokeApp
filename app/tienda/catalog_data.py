...
def get_catalog() -> dict[str, list[dict]]:
    ...
    competitivos = [
        ...
        {"name": "Blanco", "price": 4, "img": _pokeapi_item_png("ring-target"), "desc": "El portador puede recibir ataques que normalmente no le afectan."},
        {"name": "Pila", "price": 4, "img": _pokeapi_item_png("cell-battery"), "desc": "Sube el Ataque al recibir un movimiento Electrico (1 uso)."},
        {"name": "Tuberculo", "price": 4, "img": _pokeapi_item_png("absorb-bulb"), "desc": "Sube el At. Esp. al recibir un movimiento de Agua (1 uso)."},
        {"name": "Banda Atadura", "price": 4, "img": _pokeapi_item_png("binding-band"), "desc": "Aumenta el dano residual de movimientos de atadura."},
    ...
    crianza = [
        ...
        {"name": "Menta de Naturaleza", "price": 6, "img": _shop_asset("menta") or _pokeapi_item_png("leaf-stone"), "desc": "Cambia naturaleza."},
