...
def _matchup_header_html(*, jornada: int) -> str:
    return (
...
def _move_detail_html(
    ...
    return (
        ...
        f"<div class='battle-detail-stat battle-detail-stat-type'><span>Tipo</span><strong>{_type_badge_html(move.type_name)}</strong></div>"
        f"<div class='battle-detail-stat'><span>Clase</span><strong>{_category_badge_html(move.category)}</strong></div>"
        f"<div class='battle-detail-stat'><span>Potencia</span><strong>{escape(move.power)}</strong></div>"
        f"<div class='battle-detail-stat'><span>Precision</span><strong>{escape(move.accuracy)}</strong></div>"
        f"<div class='battle-detail-stat'><span>PP</span><strong>{escape(move.pp)}</strong></div>"
        "</div>"
