...
NORMATIVA_SECTIONS = [
    ...
    },
    {
        ...
        "text_lines": [
            ...
            "- Desde la jornada 4, con 8 jugadores: Liga A con 4 jugadores y Liga B con 4 jugadores.",
            "- Si la liga vuelve a tener 9 o mas jugadores, Liga A mantiene 5 jugadores y Liga B el resto.",
            "- Los jugadores solo se enfrentan contra rivales de su propia division.",
            "- Desde la jornada 4, con 8 jugadores, descienden los 2 ultimos de Liga A y ascienden los 2 primeros de Liga B.",
            "- Con 9 o mas jugadores descienden los 3 ultimos de Liga A y ascienden los 3 primeros de Liga B.",
            "- El ultimo de Liga B recibe Robar Pokemon.",
            "- Las jornadas 1-3 conservan sus puntos, monedas y divisiones historicas.",
            "- Puntos desde jornada 4 con 8 jugadores (por posicion)",
            "",
            "1: 7 /",
            "2: 6 /",
            "3: 5 /",
            ...
            "8: 1 /",
            "",
            "- Monedas desde jornada 4 con 8 jugadores (por posicion)",
            "",
            "1: 15 /",
            "2: 13 /",
            "3: 11 /",
