...
def render_topbar(section: str | None = None) -> None:
    ...
    st.markdown(
        (
            ...
            f"<span class='poke-topbar-division'>{escape(division)}</span>"
            "</div>"
            f"<div class='poke-topbar-center'>{escape(section_label)}</div>"
            ...
            "</span>"
            "<span class='poke-topbar-pill poke-topbar-notices'>"
            "<span class='poke-topbar-label'>Avisos</span>"
