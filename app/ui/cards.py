...
def ensure_type_css() -> None:
    ...
    if not css:
        css = (
            ...
            "text-align:center; color:#2b2b2b; font-family: \"Press Start 2P\", monospace; font-weight:700; }"
            ...
            ".slot .title { letter-spacing: 0.2px; font-size:0.72rem; font-weight:800; color:#1f1f1f; text-shadow: 0 0 1px currentColor; }"
            ".slot .sub { margin-top: 2px; font-size:0.68rem; color:#2b2b2b; font-weight:800; text-shadow: 0 0 1px currentColor; }"
