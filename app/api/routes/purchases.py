...
from app.api.schemas import NormalPurchaseBody, NormalPurchaseResponse
...
def post_normal_purchase(
    ...
    if container.purchase_repository is None:
        raise api_error(503, "PURCHASE_UNAVAILABLE", "Purchase backend is unavailable.")
    try:
        result = create_normal_purchase_v2(
            container.purchase_repository, season_id=str(season_id), trainer_id=principal.trainer_id,
    ...
    return NormalPurchaseResponse.model_validate(result, from_attributes=True)
