...
# Translations and display helpers (ES, ASCII)
...
NATURES_ES: dict[str, tuple[str, str | None, str | None]] = {
    ...
    "Lonely":  ("Hurana",  "attack", "defense"),
    "Brave":   ("Audaz",   "attack", "speed"),
    "Adamant": ("Firme",   "attack", "special-attack"),
    "Naughty": ("Picara",  "attack", "special-defense"),

    "Bold":    ("Osada",   "defense", "attack"),
    "Docile":  ("Docil",   None, None),
    "Relaxed": ("Placida", "defense", "speed"),
